...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente }) => {
  ...
  useEffect(() => {
    ...
    if (Object.keys(paciente).length > 0) {
      SetNombre(nombre), SetPropietario(propietario);
      SetEmail(email);
      SetAlta(alta);
      SetSintoma(sintoma);
    }
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5">
      ...
      <p className="mb-10 text-lg mt-5  text-center">
        Añade Pacientes
        <span className="font-bold text-green-700 "> Administralos</span>
      </p>
      ...
      >
        ...
        <div>
          ...
          <input
            className="border-2  p-2 w-full mt-2 mb-3 placeholder-gray-300 rounded-md "
            id="mascotas"
            type="text"
        ...
        <div>
          ...
          <textarea
            className="border-2  p-2 w-full mt-2 mb-4  placeholder-gray-300 rounded-md"
            id="sintomas"
